  ...
  server.registerTool(
    "escalate_scroll_section_issue",
    {
      ...
      description: `
        ...
        STEP 3 — Have editor_link + clear issue description + user said YES to publish.
        a) Call escalate_scroll_section_issue with: issue_description (English, detailed), editor_link, user_consented_to_publish=true. If user pasted reference URLs include them in screenshot_urls. If user attached files directly in chat set customer_attached_files=true. ALWAYS include customer_last_message_text.
